...
public class GCN_MPOrderNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCN_MPOrderNMMFactoryImpl.class.getSimpleName();
    ...
    public GCN_MPOrderNMMFactoryImpl(Application instance) {
