...
public class GCN_CustomerSrvcNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCN_CustomerSrvcNMMFactoryImpl.class.getSimpleName();
    ...
    public GCN_CustomerSrvcNMMFactoryImpl(Application instance) {
