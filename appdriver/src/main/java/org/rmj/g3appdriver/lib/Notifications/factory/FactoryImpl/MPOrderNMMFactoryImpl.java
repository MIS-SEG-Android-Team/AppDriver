...
public class MPOrderNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = MPOrderNMMFactoryImpl.class.getSimpleName();
    ...
    public MPOrderNMMFactoryImpl(Application instance) {
