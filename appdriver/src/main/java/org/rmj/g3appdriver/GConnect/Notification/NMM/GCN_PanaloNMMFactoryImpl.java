...
public class GCN_PanaloNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCN_PanaloNMMFactoryImpl.class.getSimpleName();
    ...
    public GCN_PanaloNMMFactoryImpl(Application instance) {
