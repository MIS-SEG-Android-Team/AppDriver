...
public class GCN_EventsNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCN_EventsNMMFactoryImpl.class.getSimpleName();
    ...
    public GCN_EventsNMMFactoryImpl(Application instance) {
