...
public class GCC_PromoNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCC_PromoNMMFactoryImpl.class.getSimpleName();
    ...
    public GCC_PromoNMMFactoryImpl(Application instance) {
