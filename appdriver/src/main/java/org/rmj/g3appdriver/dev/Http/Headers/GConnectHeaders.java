...
public class GConnectHeaders implements HttpHeaderProvider {
    private static final String TAG = "LiveHeaders";

    private final Application instance;

    private static GConnectHeaders poInstance;

    private GConnectHeaders(Application instance){
        this.instance = instance;
    }

    public static GConnectHeaders getInstance(Application instance){
        if(poInstance == null){
            poInstance = new GConnectHeaders(instance);
        }
