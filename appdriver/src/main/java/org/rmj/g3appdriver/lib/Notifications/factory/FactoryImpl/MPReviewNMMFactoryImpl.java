...
public class MPReviewNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = MPReviewNMMFactoryImpl.class.getSimpleName();
    ...
    public MPReviewNMMFactoryImpl(Application instance) {
