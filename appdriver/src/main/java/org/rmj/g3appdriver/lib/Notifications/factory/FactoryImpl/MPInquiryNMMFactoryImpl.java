...
public class MPInquiryNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = MPInquiryNMMFactoryImpl.class.getSimpleName();
    ...
    public MPInquiryNMMFactoryImpl(Application instance) {
