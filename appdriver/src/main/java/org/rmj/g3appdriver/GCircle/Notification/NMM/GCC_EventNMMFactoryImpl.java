...
import static org.rmj.g3appdriver.etc.UniqueIDGenerator.CreateUniqueID;
...
public class GCC_EventNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCC_EventNMMFactoryImpl.class.getSimpleName();
    ...
    public GCC_EventNMMFactoryImpl(Application instance) {
