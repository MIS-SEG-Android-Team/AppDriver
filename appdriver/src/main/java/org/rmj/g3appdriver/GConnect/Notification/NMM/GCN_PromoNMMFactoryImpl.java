...
public class GCN_PromoNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCN_PromoNMMFactoryImpl.class.getSimpleName();
    ...
    public GCN_PromoNMMFactoryImpl(Application instance) {
