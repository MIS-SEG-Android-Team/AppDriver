...
import org.rmj.g3appdriver.etc.UniqueIDGenerator;
...
public class CustomerSrvcNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = CustomerSrvcNMMFactoryImpl.class.getSimpleName();

    private final Application instance;

    private final DGCNNotificationRcv poDao;

    private String message;

    public CustomerSrvcNMMFactoryImpl(Application instance) {
        this.instance = instance;
        this.poDao = GGC_GConnectDB.getInstance(instance).nmmReceiverDao();
    }
    ...
    public String Save(RemoteMessage foVal) {
        try{
            ...
            if(poDao.CheckNotificationIfExist(lsMesgIDx) >= 1){
                ...
                String lsTransNo = UniqueIDGenerator.CreateUniqueID(poDao.GetNotificationCountForID());
