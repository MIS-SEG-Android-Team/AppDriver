...
public class TestSendCallStatus {
    ...
    public void TestSendCallUpdate() throws Exception {
        ...
        System.out.println(loTransData.get("sMobileNo"));
        System.out.println(loTransData.get("sMessagex"));
        System.out.println(loTransData.get("cSubscr"));
        ...
        System.out.println(loTransData.get("sReferNox"));
        ...
        System.out.println(loTransData.get("sUserID"));
