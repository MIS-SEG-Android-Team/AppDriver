...
public class EventNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = EventNMMFactoryImpl.class.getSimpleName();
    ...
    public EventNMMFactoryImpl(Application instance) {
