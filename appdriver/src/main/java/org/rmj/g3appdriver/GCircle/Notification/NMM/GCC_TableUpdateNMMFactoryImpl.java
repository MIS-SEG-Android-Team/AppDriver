...
public class GCC_TableUpdateNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCC_TableUpdateNMMFactoryImpl.class.getSimpleName();
    ...
    public GCC_TableUpdateNMMFactoryImpl(Application instance) {
