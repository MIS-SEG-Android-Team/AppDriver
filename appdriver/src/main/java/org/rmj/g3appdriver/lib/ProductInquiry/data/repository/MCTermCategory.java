...
package org.rmj.g3appdriver.lib.ProductInquiry.data.repository;
...
public class MCTermCategory {
    private static final String TAG = MCTermCategory.class.getSimpleName();
    ...
    public MCTermCategory(Application instance){
