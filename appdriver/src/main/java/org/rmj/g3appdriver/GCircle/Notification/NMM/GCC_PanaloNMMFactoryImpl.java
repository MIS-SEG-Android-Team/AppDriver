...
public class GCC_PanaloNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCC_PanaloNMMFactoryImpl.class.getSimpleName();
    ...
    public GCC_PanaloNMMFactoryImpl(Application instance) {
