...
public class PanaloNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = PanaloNMMFactoryImpl.class.getSimpleName();
    ...
    public PanaloNMMFactoryImpl(Application instance) {
