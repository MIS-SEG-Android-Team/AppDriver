...
public class GCN_MPInquiryNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = GCN_MPInquiryNMMFactoryImpl.class.getSimpleName();
    ...
    public GCN_MPInquiryNMMFactoryImpl(Application instance) {
