...
public class PromoNMMFactoryImpl implements NMM_Factory {
    private static final String TAG = PromoNMMFactoryImpl.class.getSimpleName();
    ...
    public PromoNMMFactoryImpl(Application instance) {
